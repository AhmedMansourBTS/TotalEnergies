...
//       RegisterToPromotionService();
//   bool _isLoading = false;
//   bool _isApplied = false; // Tracks if registration was successful
//   int custserial = 0;
...
//         if (success) {
//           setState(() {
//             _isApplied = true; // Disable button on success
//           });
//         }
...
//                 children: [
//                   Text(
//                     widget.promotion.eventEnDescription ?? 'No Description'.tr,
