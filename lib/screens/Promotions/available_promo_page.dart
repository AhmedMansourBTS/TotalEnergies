...
class AvailablePromotionsPage extends StatefulWidget {
  const AvailablePromotionsPage({super.key});

  @override
  State<AvailablePromotionsPage> createState() =>
      _AvailablePromotionsPageState();
}

class _AvailablePromotionsPageState extends State<AvailablePromotionsPage> {
