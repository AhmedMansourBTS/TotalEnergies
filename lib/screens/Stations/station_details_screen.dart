...
// import 'package:total_energies/services/get_service_by_station_service.dart';
...
//   late Future<List<StationServiceModel>> _servicesFuture;
...
//     super.initState();
//     _servicesFuture =
//         GetServicesByStationSerialService.fetchServicesByStationSerial(
...
//                         onPressed: () {
//                           setState(() {
//                             _servicesFuture = GetServicesByStationSerialService
...
//               final services =
//                   snapshot.data!; // Already filtered for validYN: true
...
//                     children: [
//                       Text(
//                         'No promotions found for this station',
//                         style: const TextStyle(
//                             color: Colors.redAccent, fontSize: 16),
//                         textAlign: TextAlign.center,
//                       ),
...
//                         children: [
//                           Text(
//                             filterError!.contains('Check internet connection')
//                                 ? 'Check internet connection'
...
class _StationDetailsScreenState extends State<StationDetailsScreen>
  ...
  Widget _buildStationDetailsTab() {
